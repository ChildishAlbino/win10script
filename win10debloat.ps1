...
$tweaks = @(
	...
	"SetBIOSTimeAEST",             # "SetBIOSTimeLocal",
...
Function InstallChoco {
	...
	Start-BitsTransfer -Source "https://raw.githubusercontent.com/ChildishAlbino/win10script/master/ooshutup10.cfg" -Destination ooshutup10.cfg
